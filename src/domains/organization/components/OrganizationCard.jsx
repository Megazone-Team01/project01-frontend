    ...
    return (
        <Card className="bg-neutral-50 hover:bg-neutral-100 hover:cursor-pointer flex h-64">
            ...
            <div className="w-1/2 h-full p-1 flex flex-col justify-center items-center">
                <p className="flex-1 flex justify-center items-center text-base font-bold" id="name"> 메가존 아카데미 </p>
                <p className="flex-1 flex justify-center items-center text-gray-500" id="type"> 온라인 </p>
